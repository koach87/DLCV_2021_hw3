...
# add attn in TransformerDecoderLayer.forward_post and forward_pre
# add attn in TransformerDecoder
# add 0 output in DecoderEmbeddings
import copy
...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, pos_embed, tgt, tgt_mask):
        ...
        hs, attn = self.decoder(tgt, memory, memory_key_padding_mask=mask, tgt_key_padding_mask=tgt_mask,
